      ...
      <body style="font-family: 'Inter', sans-serif; background-color: #f8f9fb; padding: 40px; margin: 0;">
        <div style="max-width: 520px; margin: auto; background: #ffffff; border-radius: 14px; padding: 40px 35px; box-shadow: 0 4px 14px rgba(0,0,0,0.08);">
          ...
          <div style="text-align: center;">
            <img src="https://i.imgur.com/oZRLZyD.png" alt="arcmindAI Logo" width="80" height="80" style="border-radius: 12px; margin-bottom: 10px;" />
          ...
          <p style="color: #888; font-size: 13px; text-align: center; margin-top: 24px;">
            ...
            <a href="mailto:support@arcmindai.com" style="color: #4f46e5; text-decoration: none;">arcmindai@gmail.com</a>
          </p>
