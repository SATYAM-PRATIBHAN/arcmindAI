...
export type GenerationModel =
  runtime.Types.Result.DefaultSelection<Prisma.$GenerationPayload>;
...
type GetGenerationGroupByPayload<T extends GenerationGroupByArgs> =
...
export type GenerationCreateNestedManyWithoutUserInput = {
  ...
  connect?:
    | Prisma.GenerationWhereUniqueInput
    | Prisma.GenerationWhereUniqueInput[];
};
...
export type GenerationUpdateManyWithoutUserNestedInput = {
  ...
  updateMany?:
    ...
    | Prisma.GenerationUpdateManyWithWhereWithoutUserInput[];
  deleteMany?:
    | Prisma.GenerationScalarWhereInput
    | Prisma.GenerationScalarWhereInput[];
};
...
export type GenerationCreateManyUserInputEnvelope = {
  data:
    | Prisma.GenerationCreateManyUserInput
    | Prisma.GenerationCreateManyUserInput[];
};
...
> = runtime.Types.Extensions.GetOmit<
  "id" | "createdAt" | "updatedAt" | "userInput" | "generatedOutput" | "userId",
  ExtArgs["result"]["generation"]
>;
...
export type GenerationGetPayload<
  S extends boolean | null | undefined | GenerationDefaultArgs,
...
> {
  ...
  /**
   * Find zero or more Generations that matches the filter.
   * @param {GenerationFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const generation = await prisma.generation.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(
    args?: Prisma.GenerationFindRawArgs,
  ): Prisma.PrismaPromise<Prisma.JsonObject>;

  /**
   * Perform aggregation operations on a Generation.
   * @param {GenerationAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const generation = await prisma.generation.aggregateRaw({
   *   pipeline: [
   ...
   */
  aggregateRaw(
    args?: Prisma.GenerationAggregateRawArgs,
  ): Prisma.PrismaPromise<Prisma.JsonObject>;
  ...
  >(
    args: Prisma.SubsetIntersection<T, GenerationGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetGenerationGroupByPayload<T>
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.GenerationUpdateInput,
    Prisma.GenerationUncheckedUpdateInput
  >;
  /**
 ...
 * Generation findRaw
 */
export type GenerationFindRawArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
...
/**
 * Generation aggregateRaw
 */
export type GenerationAggregateRawArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
