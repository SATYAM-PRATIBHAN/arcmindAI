...
export default function D3Canvas({ chart }: D3CanvasProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-162.5 overflow-hidden bg-[#0a0c10] border border-border/40 rounded-2xl flex"
    >
      {/* Canvas Area */}
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        className={`w-full h-full rounded-2xl border bg-linear-to-br flex flex-col p-3 text-left transition-all duration-300 select-none shadow-md ${style.color} ${
                          isNodeSelected
                      ...
                      >
                        ...
                        <div className="flex items-start gap-2 flex-1 min-w-0">
                          <IconComponent className="w-4 h-4 text-neutral-400 mt-0.5 shrink-0" />
                ...
                .map((link, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="font-bold text-foreground truncate max-w-25">
                        {otherNode.label}
                      </span>
                    </div>
                  );
